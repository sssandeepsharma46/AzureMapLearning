    ...
    var loadMap = function(){
        ...
        map.events.add("ready", function(){
            ...
            $("#assetsstatus").on("change", function(){
                var ddOptions = $("#assetsstatus");
                if(parseInt(ddOptions[0].value) === -1){
                    filterByAssetsStatus = "<condition attribute='dnlb_assetsstatus' operator='null' />";
                }else
                {
                    filterByAssetsStatus = "<condition attribute='dnlb_assetsstatus' operator='eq' value='"+parseInt(ddOptions[0].value)+"' />";
                }
                dataSource.clear();
                lineDataSource.clear();
                features = [];
                addResources();
            })
